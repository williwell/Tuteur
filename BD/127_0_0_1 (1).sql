...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 03, 2021 at 02:23 PM
...
--
-- Table structure for table `commentaire_tutoré`
--

DROP TABLE IF EXISTS `commentaire_tutoré`;
CREATE TABLE IF NOT EXISTS `commentaire_tutoré` (
...
--
-- Table structure for table `tutoré`
--

DROP TABLE IF EXISTS `tutoré`;
CREATE TABLE IF NOT EXISTS `tutoré` (
  `Matricule` varchar(7) NOT NULL,
...
--
-- Table structure for table `élèves`
--

DROP TABLE IF EXISTS `élèves`;
CREATE TABLE IF NOT EXISTS `élèves` (
  `Matricule` varchar(7) NOT NULL,
  `Nom` varchar(200) NOT NULL,
  `Courriel` varchar(200) NOT NULL,
...
INSERT INTO `élèves` (`Matricule`, `Nom`, `Courriel`, `Programme`, `Téléphone`, `Enseignant_ressource`) VALUES
